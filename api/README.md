...
2) "cashRegisterState" -  Запрос состояния кассы (PPO)          
       ...
       Параметры: numFiscal- номер кассы (PPO)
...
9) "сheckShow" - получить существующий чек        

          Параметры numFiscal - Фискальный номер чека
...
10) "zFormShow" - получить существующий z-отчёт
          ...
          Параметры numFiscal - Фискальный номер Z-отчета
